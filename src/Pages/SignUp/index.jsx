    ...
    return(
        <section className="bg-white w-full h-full">
            ...
            <div className="loginBox card w-[600px] h-[auto] pb-20 mx-auto pt-20 relative z-50">
                ...
                <h1 className="text-center text-[30px] text-[#191919] font-[800] mt-0">Join us today! Get special<br/>
                ...
                <form className="w-full px-8 mt-3">
                    ...
                    <div className="form-group mb-4 w-full flex items-center justify-between">
                        ...
                        <Link to="/login" className="text-primary font-[700] text-[15px] hover:underline hover:text-gray-600">Alredy Rejistered?</Link>
                    </div>
